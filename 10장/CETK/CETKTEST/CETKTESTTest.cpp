...
{
    static  TCHAR   szHeader[] = TEXT("CETKTEST: ");
    TCHAR   szBuffer[1024];
...
SHELLPROCAPI ShellProc(UINT uMsg, SPPARAM spParam)
{
    ...
    case SPM_BEGIN_GROUP:
        ...
        g_pKato->BeginLevel(0, TEXT("BEGIN GROUP: CETKTEST.DLL"));
        break;
    ...
    case SPM_END_GROUP:
        ...
        g_pKato->EndLevel(TEXT("END GROUP: CETKTEST.DLL"));
        break;
